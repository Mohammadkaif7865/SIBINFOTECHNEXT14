                 ...
                 <div className="row">
			        <div className="col-lg-7 ps-lg-5">
    					<div className="innerBannerTitle venter">
    						...
    						<h1 className="heading fontWeight700 text-white">Youtube Marketing</h1>
                     <h2 className="small_heading fw-bold mt-3 text-white">Top Rated YouTube Marketing Company in India</h2>
