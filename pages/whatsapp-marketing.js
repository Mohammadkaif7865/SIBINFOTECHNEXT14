                 ...
                 <div className="row">
			        <div className="col-lg-7 ps-lg-5">
    					<div className="innerBannerTitle venter">
    						<h1 className="heading fontHeading fontWeight700 text-white">Whatsapp Marketing</h1>
                     <h2 className="small_heading fw-bold mt-3 text-white">Top Rated WhatsApp Marketing Company in India</h2>
