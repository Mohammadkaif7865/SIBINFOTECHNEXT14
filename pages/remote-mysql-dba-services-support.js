...
export default function RemoteMysqlDbaSupportServices() {
  const metaTags = (
    <>
      ...
      <meta
        name="description"
        content="Ensure optimal performance with remote MySQL DBA services in India by SIB Infotech. Expert support for database management, security, and performance tuning."
      />
      ...
      <meta
        property="og:url"
        content="https://www.sibinfotech.com/remote-mysql-dba-services-support"
      />
      <meta
        property="og:title"
        content="Remote MySQL DBA Services & Support | SIB Infotech"
      />
      <meta
      ...
      <BreadcrumbSchema
        ...
        breadcrumbTitle="Remote MySQL DBA Services & Support | SIB Infotech"
        PageRatingSchema
        description={
          "Ensure optimal performance with remote MySQL DBA services in India by SIB Infotech. Expert support for database management, security, and performance tuning."
        }
        reviewCount={"5265"}
      />
    </>
  ...
  return (
    <CustomLayout meta={metaTags}>
      ...
      <div className="d-lg-none d-lg-block">
        <Breadcrumb Pagetitle={"Remote MySQL DBA Services"} />
      </div>
      <div className="col-lg-5 d-block d-lg-none pe-lg-5">
        <div className="bannerForm">
          ...
          <p>
            ...
            <strong className="fontWeight600 text_red">
              Best{" "}
              <span className="textChange">Remote MYSQL DBA Services </span>{" "}
              Company in India
            </strong>
          </p>
          <BannerForm />
            ...
            <div className="col-md-8 order-lg-1 order-2">
              <div className="col-md-12">
                <div className="custom-content-title">
                  <p>Our MySQL database administrators are experienced with</p>
                </div>
              </div>
              <div className="row">
                <div className="col-md-6">
                  <ul>
                    <li>
                      <p>
                        Building High End Database systems using Oracle MySQL,
                        Percona MySQL and MariaDB.
                      </p>
                    </li>
                    <li>
                    ...
                    <li>
                      <p>High Availability Solutions.</p>
                    </li>
                    <li>
                      <p>
          ...
          <div className="row">
            ...
            <div className="col-md-8">
              <div className="col-md-12">
                <div className="custom-content-title">
                  <p>
                    Below are a few MySQL technologies and products we support
                  </p>
                </div>
              </div>
              <div className="row">
                ...
                <div className="col-md-6">
                  <ul>
                    <li>
                      <p>
                        MySQL Storage Engines (MyISAM, InnoDB/XtraDB/TokuDB, and
                        more)
                      </p>
                    </li>
                    <li>
                      <p>NoSQL with MySQL</p>
                    </li>
                    <li>
                      <p>
                        MySQL Replication (Master-Slave, Master-Master,Chained
                        Replication)
                      </p>
                    </li>
                    <li>
