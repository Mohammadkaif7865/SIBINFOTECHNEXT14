            ...
            <div className="col-lg-7 ps-lg-5">
              <div className="innerBannerTitle venter">
                ...
                <h2 className="small_heading fw-bold mt-lg-3 mt-2 text-white">
                  Top Rated Forum Posting Company in India
                </h2>
                <div className="mt-4">
              ...
              <div className="bannerForm">
                ...
                <p>
                  ...
                  <strong className="fontWeight600 text_red">
                    Best{" "}
                    <span className="textChange">Forum Postings Services </span>{" "}
                    Company in India
                  </strong>
                </p>
                <BannerForm />
      ...
      <div className="col-lg-5 d-block d-lg-none pe-lg-5">
        <div className="bannerForm">
          ...
          <p>
            with{" "}
            <strong className="fontWeight600 text_red">
              Best <span className="textChange">Forum Postings Services </span>{" "}
              Company in India
            </strong>
          </p>
          <BannerForm />
        ...
        <div className="containerFull">
          <div className="row">
            ...
            <div className="col-md-10">
              <div className="service-sub-title">
                <p>
                  Forum posting service is a nice way of getting topic based
                  links and getting the right kind of traffic on your website.
                </p>
              </div>
            </div>
            <div className="col-md-1">&nbsp;</div>
          ...
          <div className="row">
            <div className="col-md-6 order-2 order-lg-1">
              <p>
                It is an important stance in boosting SEO efforts. It’s simply
                means posting new threads or replying to old ones in forums to
                get quality inbound links to a website. If it is done in proper
                manner then it can drive targeted traffic to a website. Forum
                Posting is one of the best ways to connect your potential
                viewers and encouraging them to check out your website.
              </p>
              <p>
                SIB Infotech is an unmatched and top Forum Posting specialist
                and can assist you to make and build a huge database of posts to
                detain customers. We are an online service specializing in
                providing affordable, quality &amp; user-friendly content to
                websites. Our signature service is BOOST paid forum posting,
                which is a forum population service that brings users &amp;
                posts to your website to bring the site to life and make it
                active.
              </p>
            </div>
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <div className="custom-content-title">
                <p>Key Benefits of Forums</p>
              </div>
              <ul>
                <li>
                  <p>Signatures towards your money site (exceptional case)</p>
                </li>
                <li>
                  <p>Direct Marketing of your niche</p>
                </li>
                <li>
                  <p>Bring direct and indirect traffic towards your site.</p>
                </li>
                <li>
                  <p>
                    Forums are the best approach for providing good quality
                    information
                  </p>
                </li>
              </ul>
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="custom-content-title">
                <p>Features of the Forum Service</p>
              </div>
              ...
              <div className="row m-zero">
                <div className="col-md-4">
                  <div className="custom-page-icon-box">
                    <p>Replying to the old threads and creating new threads</p>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="custom-page-icon-box">
