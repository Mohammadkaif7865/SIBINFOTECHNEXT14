...
export default function MobileSeoServices() {
  const metaTags = (
    <>
      ...
      <meta property="og:image" content="https://www.sibinfotech.com/assets/og/mobile-seo-services.webp" />
      ...
      <meta property="twitter:image" content="https://www.sibinfotech.com/assets/og/mobile-seo-services.webp" />
      <BreadcrumbSchema
        ...
        <div className="containerFull">
          <div className="row">
            <div className="col-lg-7">
              <p className="customText text-justify">
                ...
                with your firm and your products. They have need of a much
                active &amp; quicker experience.
              </p>
              <p className="customText text-justify">
                ...
                with optimizing it for mobile search results and high-quality
                user experience. A combination of accurate SEO tools is the key
                to successful and effective mobile SEO services.
              </p>
              <p className="customText">
                Almost 40% of the sales these days are done online via the
                business websites. If a business wants to engage mobile users
                and convert them into loyal customers, Mobile SEO should be your
                top prioritized investment. Mobile SEO enables your website to
                rank better and generate heavy leads on your page.
              </p>
              <p className="customText">
                ...
                internet surfing, each of them considers visiting
                mobile-friendly websites. Mobile-friendly websites are preferred
                by Google itself.
              </p>
            </div>
          ...
          <div className="row">
            <div className="col-lg-6">
              <p className="customText">
                Search engines are considered to be the most reliable platforms
                to digitally grow your brand to the farthest corners of the
                digital world. Mobile optimization of your website ensures that
                it functions properly and looks attractive on the devices.
              </p>
              <p className="customText">
                ...
                is an essential tool for growing and expanding their services
                and sales.
              </p>
            </div>
            <div className="col-lg-6">
              <p className="customText">
                What can be done to be certain that your website is
                well-optimized according to the mobile SEO key determining
                factors? Answer to the query is far simple, which is to hire a
                well-experienced and expert Mobile SEO company. But the solution
                is far more complex; Mobile SEO tools require expertise to
                deploy highly engaging websites of your brand. SIB Infotech is
                one of the leading SEO service providing companies in India. Our
                services ensure that your brand gets 200% results for what you
                are investing in our services.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="row align-items-center">
            <div className="col-lg-4 leftDigiSer">
              <div className="heading-section">
                ...
                <p className="customText text-off-white">
                  ...
                  impacted by your website's content and interface, services,
                  and products.
                </p>
                <p className="customText text-off-white">
                  Almost 52% of the users that do not find a website
                  mobile-friendly do not engage with the brand again, our
                  services make it certain that your website is optimized in
                  such a way the audience can’t deny visiting it again.
                </p>
              </div>
            </div>
            <div className="col-lg-8 mt-lg-0 mt-3">
              <p className="customText text-center">
                <b>
                  The benefits from mobile optimization for your company's
                  website are uncountable, few can be listed :
                </b>
              </p>
      ...
      <section className="customPadding">
        <div className="containerFull">
          ...
          <p className="customText text-center">
            ...
            affected by various Mobile SEO elements. These elements or factors
            are responsible for search engine rankings, search visibility, and
            optimal user experience. SEO experts at SIB make sure that your page
            is well-optimized and no affecting key factor is left unattended. We
                ...
                <div className="col-lg-6">
                  <div className="off-page-seo-box">
                    ...
                    <p className="customText">
                      ...
                      not need to zoom in or out to read the content on the
                      page.
                    </p>
                  </div>
                </div>
              ...
              <div className="row">
                <div className="col-lg-6">
                  <div className="off-page-seo-box">
                    ...
                    <p className="customText">
                      the web browsers are attracted majorly to the websites
                      that look attractive and are easy to navigate. Mobile
            ...
            <div className="col-lg-7">
              <div className="row">
                <div className="col-lg-6">
                  <div className="off-page-seo-box">
                    ...
                    <p className="customText">
                      User is easily irritated with pop-ups as it is difficult
                      to close them each time. Pop-ups can lead to high bounce
                      rates dues to audience dissatisfaction.
                    </p>
                  </div>
                </div>
                <div className="col-lg-6">
                  <div className="off-page-seo-box">
                    ...
                    <p className="customText">
                      ...
                      mobile-friendly websites separated from the desktop ones
                      to exterminate indexing problems.
                    </p>
                  </div>
                </div>
              </div>
              <div className="off-page-seo-box off-page-seo-box-ex-height">
                ...
                <p className="customText">
                  ...
                  information that determines if the website is mobile-friendly
                  or not. The search crawlers need access to the scripts to rank
                  the websites on SERPs. These scripts play an important role to
                  ensure that the search engines fully render your website. Back
                  a few years, some of these technologies were not supported by
              ...
              <div className="off-page-seo-box off-page-seo-box-height">
                ...
                <p className="customText">
                  ...
                  dominant role in determining if the user finds your website
                  when they search for the services near themselves. The
                  audience often searches for a local business near them, the
                  local information plays its part in such situations. If your
                  business involves local or geographical based services or
                  elements never ignore them to be optimized for mobile content
                  for local searches. It includes the name of your company,
                  address, contact details along with your city and state name
                  in the website's metadata.
                </p>
              </div>
            </div>
            <div className="col-lg-5">
          ...
          <div className="row">
            <div className="col-lg-6">
              <h3 className="customHeading">
                Go Mobile-ready with our{" "}
                <span className="text_red">Mobile SEO</span> services
              </h3>
              <p className="customText">
                Experts at SIB have deep knowledge about mobile websites and
                applications, they optimize your content and site experience to
                engage huge traffic and yield desirable SEO results. Our mobile
                SEO service ensures that all the key contributing factors of
                your website are efficiently maintained to acquire 100% positive
                results.
              </p>
              <img
                className="image-full"
            ...
            <div className="col-lg-6">
              <div className="row">
                ...
                <div className="col-lg-6 mobile-seo-servives-list">
                  <ul>
                    <li className="customText">Website UI analysis</li>
                    ...
                    <li className="customText">Click to Call Action</li>
                    <li className="customText">Robot.txt implementation</li>
                    <li className="customText">
                      Meta description and title tag optimization
                    </li>
                    <li className="customText">Cautiously designed pop-ups</li>
                  </ul>
                </div>
                <div className="col-lg-6 mobile-seo-servives-list">
                  <ul>
                    <li className="customText">Local SEO</li>
                    <li className="customText">Mobile Sitemaps</li>
                    <li className="customText">Mobile optimization audits</li>
                    <li className="customText">24*7 Maintenance and support</li>
                    <li className="customText">Regular performance reports</li>
                    <li className="customText">
                      Transparent progress statistics
                    </li>
                    <li className="customText">
                      Website content inspection and optimization
                    </li>
                  </ul>
                </div>
                <div className="clearfix">&nbsp;</div>
                <p className="customText">
                  We provide the best mobile SEO services that guarantee desired
                  outcomes for your website along with heightened sales and
                  boosted traffic.
                </p>
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-lg-8 offset-lg-2">
                <h4 className="text-white">
                  Are you ready to lead the SERPs with your Mobile website?
                </h4>
                <p className="customText text-off-white">
                  Hire us to get your website on the first page of Google's
                  mobile search results.
                </p>
                <h3 className="customHeading text-white">
                  We are the Best Mobile SEO agency in India
                </h3>
