            ...
            <div className="col-lg-7 ps-lg-5">
              <div className="innerBannerTitle venter">
                ...
                <h2 className="small_heading fw-bold mt-3 text-white">
                  Top Rated CMS Development Company in India
                </h2>
                <div className="mt-4">
      ...
      <div className="col-lg-5 d-block d-lg-none pe-lg-5">
        <div className="bannerForm">
          ...
          <p>
            with{" "}
            <strong className="fontWeight600 text_red">
              Best <span className="textChange">CMS Based Web Development</span>{" "}
              Company in India
            </strong>
          </p>
          <BannerForm />
          ...
          <div className="row">
            ...
            <div className="col-lg-7">
              <p className="customText">
                SIB Infotech is among top{" "}
                <strong>
                  WordPress Development Company in Mumbai and Delhi, India.
                </strong>{" "}
                Our WordPress developers and designers will help you get the
                best WordPress website functioning at the most affordable cost.
                We can use any theme and customize the theme or even develop
                theme from scratch to meet your exact requirements.
              </p>
              <p className="customText">
                Wordpress is a CMS platform where we can develop websites that
                are easily manageable and easily accessible. Therefore, most of
                the clients now prefer to have a WordPress website which has
                resulted in dramatic increase of WordPress websites. In fact,
                with 60% customers of the overall market, WordPress holds a
                dominating position in Content management systems.
              </p>
              <p className="customText">
                Undoubtedly, WordPress websites are the most affordable websites
                and on the other hand, we can get endless plugins to get a
                website according to the requirement.
              </p>
              <p className="customText">
                Whether you're building a small business website, personal
                portfolio or e-commerce website, WordPress has got everything
                you need. From blogging to e-commerce to business and portfolio
                websites, WordPress is your one stop solution.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="row">
              <div className="col-lg-8 offset-lg-2">
                <h4 className="text-center fontHeading">
                  Web applications served by our developers using CMS
                </h4>
              </div>
            </div>
            <div className="row">
              ...
              <div className="col-lg-3 col-6">
                <div className="itemDigital">
                  ...
                  <h5>E learning website development</h5>
                </div>
              </div>
              <div className="col-lg-3 col-6">
                <div className="itemDigital">
                  ...
                  <h5>Dating website development</h5>
                </div>
              </div>
              <div className="col-lg-3 col-6">
                <div className="itemDigital">
                  ...
                  <h5>Real state website development</h5>
                </div>
              </div>
              <div className="col-lg-3 col-6">
                <div className="itemDigital">
                  ...
                  <h5>CMS based website development</h5>
                </div>
              </div>
              <div className="col-lg-3 col-6">
                <div className="itemDigital">
              ...
              <div className="col-lg-3 col-6">
                <div className="itemDigital">
                  ...
                  <h5>Social networking development</h5>
                </div>
              </div>
              <div className="col-lg-3 col-6">
                <div className="itemDigital">
                  ...
                  <h5>Membership based development</h5>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="containerFull">
          <div className="row justify-content-center">
            <h4 className="customHeading customLineHeight2 text-center">
              8 reasons why business should choose{" "}
            ...
            <div className="row">
              <div className="col-lg-3">
                <div className="itemBenefitsNew2">
                  ...
                  <h5>Niche audience</h5>
                  <p>
                    You will get targeted customer as per your business
                    requirements.
                  </p>
                </div>
              </div>
              <div className="col-lg-3">
                <div className="itemBenefitsNew2">
                  ...
                  <h5>Wider reach</h5>
                  <p>
                    It provide you a wider reach as everyone today is using
                    internet.
                  </p>
                </div>
              </div>
              <div className="col-lg-3">
                <div className="itemBenefitsNew2">
                  ...
                  <h5>Caters to mobile customers</h5>
                  <p>
                    It's a cheaper technique as compare to traditional
                    marketing.
                  </p>
                </div>
              </div>
              <div className="col-lg-3">
                <div className="itemBenefitsNew2">
                  ...
                  <h5>Time Saving</h5>
                  <p>
                    It is a very time saving concept as we need not to go
                    anywhere to run the ads and to track the results.
                  </p>
                </div>
              </div>
              <div className="col-lg-3">
                <div className="itemBenefitsNew2">
                  ...
                  <h5>Direct engagement with customers</h5>
                  <p>
                    It provide you the platform where you can easily interact
                    with your customers through email, chats, etc.
                  </p>
                </div>
              </div>
              <div className="col-lg-3">
                <div className="itemBenefitsNew2">
                  ...
                  <h5>Provide right direction</h5>
                  <p>
                    It provide a right direction to the business provide
                    information about the current market trends, behavior of the
                    users and their relevant information.
                  </p>
                </div>
              </div>
              <div className="col-lg-3">
                <div className="itemBenefitsNew2">
                  ...
                  <h5>Increase ROI</h5>
                  <p>
                    It helps you to enhance the ROI as it has the more wider
                    reach and more targeted customers.
                  </p>
                </div>
              </div>
              <div className="col-lg-3">
            ...
            <div className="row">
              <div className="col-lg-8 offset-lg-2">
                <h3 className="customLineHeight2 fontHeading">
                  ...
                  creating cutting edge innovative digital campaigns and
