...
export default function ContentMarketingServices() {
  ...
  const faqDescription = `Build brand authority and drive organic growth with
          ...
          <div className="row">
            <div className="col-lg-7 ps-lg-5">
              <div className="innerBannerTitle venter">
                <h1 className="heading fontHeading fontWeight700 text-white fontHeading">
              ...
              <div className="bannerForm">
                ...
                <p>
                  ...
                  <strong className="fontWeight600 text_red">
                    Best <span className="textChange">Content Marketing</span>{" "}
                    Company in India
                  </strong>
                </p>
                <BannerForm />
      ...
      <div className="col-lg-5 d-block d-lg-none pe-lg-5">
        <div className="bannerForm">
          ...
          <p>
            with{" "}
            <strong className="fontWeight600 text_red">
              Best <span className="textChange">Content Marketing</span> Company
              in India
            </strong>
          </p>
          <BannerForm />
          ...
          <div className="row">
            <div className="col-md-6">
              <h3 className="customHeading ">
                Tell your <span className="text_red">Brand Story</span> Better,{" "}
                <span className="text_red">Engage better</span> with your
                Audience
              </h3>
              <p className="customText">
                Content is King it is the most important contributing factor in
                engaging and attracting audience. Content marketing is a
                strategic marketing tool that focuses on creating and
                distributing valuable, appropriate and reliable content to
                attract and preserve the target audience to ensure profitable
                consumer actions and hence it is termed as one of the most power
                digital marketing strategy. Quality content is marked by right
                amount of targeted words and with specific content to tell your
                brand stories better which could bring in more customer
                engagement.
              </p>
              <p className="customText">
                Content marketing can convey your brand message in many ways,
                content is found everywhere, be it videos, blogs or pictures.
                It’s how you show your content a good content would always
                incorporate latest trends, understands consumer expectations and
                the always changing marketing world. Content marketing services
                helps you in regular creation and curation of good content.
              </p>
              <p className="customText">
                Every business in today’s world is highly influenced by the
                internet and around 80% of the customers are attracted to the
                business via the digital world where content is considered to be
                the most superior factor.
              </p>
              <p className="customText">
                A brand that has effective and reliable content on their
                websites can be assured
              </p>
            </div>
            <div className="col-md-6">
              <img
              ...
              />
              <p className="customText">
                that their brand image can be boosted on the search engines in
                no time.
              </p>
              <p className="customText">
                Businesses use content marketing to boost lead generation and
                sales by analytics, keyword integration and implementing
                effective strategies. It is a long-term strategic tool that uses
                content for building strong and long-lasting relations with the
                audience to improve brand reputation and increase awareness.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="leftDigiSer h-lg-100 exPadding">
                <div className="heading-section">
                  ...
                  <p className="customText text-off-white">
                    Content marketing is the greatest source for creating brand
                    awareness, user interest, product consideration and sales.
                  </p>
                  <p className="customText text-off-white">
                    The content marketing mediums are spread everywhere in the
                    online world, all your business need is a reliable and
                    effective content marketing company that can has solution to
                    all the content marketing problems.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="middle-row">
                <div className="middle-box middle-box-ex-width">
                  ...
                  <h4 className="fontHeading">
                    Condensed marketing and sales overhead
                  </h4>
                </div>
                <div className="middle-box middle-box-ex-width">
                  <img
          ...
          <div className="row">
            <div className="col-lg-3">
              <div className="content-marketing-box">
                ...
                <h4 className="fontHeading">Brand awareness</h4>
                <ul>
                  <li className="customText">Blogs</li>
                  <li className="customText">Infographics</li>
                  <li className="customText">Social media posts</li>
                  <li className="customText">Podcasts</li>
                </ul>
              </div>
            </div>
            <div className="col-lg-3">
              <div className="content-marketing-box">
                ...
                <ul>
                  <li className="customText">Display advertisements</li>
                  <li className="customText">Conversion landing pages</li>
                  <li className="customText">Explanatory videos</li>
                  <li className="customText">eBooks</li>
                </ul>
              </div>
            </div>
            <div className="col-lg-3">
              <div className="content-marketing-box">
                ...
                <ul>
                  <li className="customText">Testimonials</li>
                  <li className="customText">Demos</li>
                  <li className="customText">Reviews</li>
                  <li className="customText">FAQs</li>
                </ul>
              </div>
            </div>
            <div className="col-lg-3">
              <div className="content-marketing-box">
                ...
                <ul>
                  <li className="customText">Trial sample or content</li>
                  <li className="customText">Sales mails</li>
                  <li className="customText">On-site testimonials</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div className="containerFull">
          <div className="row">
            <div className="col-lg-6">
              <p className="customText">
                SIB Infotech is the best content marketing company in Mumbai,
                offering the top content marketing strategy in India. Our
                strategy covers every medium of content marketing tools that are
                based on the four stages of sales.
              </p>
              <p className="customText">&nbsp;</p>
            </div>
            <div className="col-lg-6">
              <p className="customText">
                We are among the top content marketing agency in India offering
            ...
            <div className="col-lg-7">
              <div className="section-4-left">
                ...
                <h3 className="customHeading text-white fontHeading">
                  Ready to provide you content marketing services
                </h3>
                <p className="customText text-white">
                  with a FREE Consultation to get it started
                </p>
              </div>
            </div>
            <div className="col-lg-5">
      ...
      <section>
        <div className="containerFull">
          <div className="row">
            ...
            <div className="col-lg-6">
              <h3 className="customHeading">
                Our Unique <span>Content Marketing</span> Service
              </h3>
              <p className="customText">
                Content is created by everyone and is created in abundance
                making it difficult for a great content to be lost on the web.
                Therefore, it is very important to create unique, Compelling and
                specific content. Content marketing is the heart of the SEO and
                Link Building strategy as it play a vital role in search engine
                ranking, attracting quality traffic and creating a buzz for
                social sharing. We guarantee to take your brand to great heights
                with our reliable strategies which are based upon your brand’s
                requirements and goals. Quality content always takes time and
                patience to be ready, it requires a lot of thought process and
                research to bring in a unique content. Its not only content
                creation which is important marketing the content correctly also
                plays an important role to gain visibility.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bgGrey">
        <div className="containerFull">
          <div className="content-marketing-row">
            <div className="row">
              <div className="col-lg-6">
                <div className="content-marketing-box2">
                  <div className="content-marketing-box2-content-box">
                    <h4>Content Marketing Goals</h4>
                    <ul>
                      <li className="customText">
                        Deciding what the user attains from your content
                      </li>
                      <li className="customText">Setting up business goals</li>
                      <li className="customText">
                        Estimating your business industry and content need
                      </li>
                    </ul>
                  </div>
              ...
              <div className="col-lg-6">
                <div className="content-marketing-box3">
                  ...
                  <div className="content-marketing-box2-content-box">
                    <h4>Content Marketing Audience analysis</h4>
                    <ul>
                      <li className="customText">
                      ...
                      <li className="customText">
                        Deciding target audience and their needs
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div className="row">
              <div className="col-lg-6">
                <div className="content-marketing-box2">
                  <div className="content-marketing-box2-content-box">
                    <h4>Content Marketing Website analysis</h4>
                    <ul>
                      <li className="customText">Content audit and analysis</li>
                      <li className="customText">
                        Analysing content for keywords
                      </li>
                      <li className="customText">Identifying content gaps</li>
                    </ul>
                  </div>
                  <div className="content-marketing-box2-img-box">
                    <img
              ...
              <div className="col-lg-6">
                <div className="content-marketing-box3">
                  ...
                  <div className="content-marketing-box2-content-box">
                    <h4>Content Marketing key indicators</h4>
                    <ul>
                      <li className="customText">Revenue targets</li>
                      <li className="customText">Increase sign-ups</li>
                      <li className="customText">Improve search rankings</li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div className="row">
              <div className="col-lg-6">
                <div className="content-marketing-box2">
                  <div className="content-marketing-box2-content-box">
                    <h4>Content Marketing Channels</h4>
                    <ul>
                      <li className="customText">
                        Determining platforms that engage most audience
                      </li>
                      <li className="customText">
                        Deciding which channel is best for engaging target
                        audience
                      </li>
                    </ul>
                  </div>
              ...
              <div className="col-lg-6">
                <div className="content-marketing-box3">
                  ...
                  <div className="content-marketing-box2-content-box">
                    <h4>Content Marketing Planning</h4>
                    <ul>
                      <li className="customText">
                        Posting content according to market trends
                      </li>
                      <li className="customText">
                        Pre-planned schedule eliminates confusion of 'what
                        next?'
                      </li>
                    </ul>
                  </div>
            ...
            <div className="row">
              <div className="col-lg-6">
                <div className="content-marketing-box2">
                  <div className="content-marketing-box2-content-box">
                    ...
                    <ul>
                      <li className="customText">Content research</li>
                      <li className="customText">Quality content creation</li>
                      <li className="customText">Keyword integration</li>
                    </ul>
                  </div>
                  <div className="content-marketing-box2-img-box">
                    <img
              ...
              <div className="col-lg-6">
                <div className="content-marketing-box3">
                  ...
                  <div className="content-marketing-box2-content-box">
                    <h4>Content Marketing Reporting and statistics</h4>
                    <ul>
                      <li className="customText">Monthly reports</li>
                      <li className="customText">
                        Traffic &amp; reach reports
                      </li>
                      <li className="customText">Transparent statistics</li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div className="row">
              <div className="col-lg-6">
                <div className="content-marketing-box2">
                  <div className="content-marketing-box2-content-box">
                    <h4>Content Marketing Type</h4>
                    <ul>
                      <li className="customText">Blogs</li>
                      <li className="customText">Podcasts</li>
                      <li className="customText">Videos</li>
                      <li className="customText">Advertisements</li>
                    </ul>
                  </div>
                  <div className="content-marketing-box2-img-box">
                    <img
              ...
              <div className="col-lg-6">
                <div className="content-marketing-box3">
                  ...
                  <div className="content-marketing-box2-content-box">
                    <h4>Content Marketing distribution</h4>
                    <ul>
                      <li className="customText">
                        Distributing the content on the estimated channels
                      </li>
                      <li className="customText">
                        Direct your content to most crucial parts of the website
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <p className="customText text-center">
            We help your brand to grow and reach the market’s top shelves with
            our hard work and extremely efficient strategies. As a digital
            marketing giant in India, we offer highly effective services to our
            customers in an ever-changing online world. We believe that each
            brand or business has different requirements and goals and we offer
            custom tailor-made services for all their requirements as per their
            needs. We always make certain that your company gets the exposure it
            needs.
          </p>
        </div>
      </section>
        ...
        <div className="containerFull">
          <div className="callAction">
            <h4 className="customLineHeight fontHeading">
              Are you Ready to reach out to your prospects through our unique
              <br />
              content marketing services today?
            </h4>
            <p className="customText text-white">
              Partner with #1 Content Marketing Agency in India for ultimate
              content marketing solutions for your brand
            </p>
