...
export default function DatabaseDevelopementMumbaiIndia() {
  const metaTags = (
    <>
      ...
      <meta
        name="keywords"
        content="database development services,database development service,offshore database development,database development companies,database development company,database development india,database development delhi,database development mumbai,database development che"
      />

      <meta property="og:type" content="website" />
      <meta
        property="og:url"
        content="https://www.sibinfotech.com/database-development-mumbai-india"
      />
      <meta
        property="og:title"
        content="Database Development Services Company in Mumbai, India"
      />
      <meta
      ...
      <BreadcrumbSchema
        ...
        breadcrumbTitle="Database Development Services Company in Mumbai, India"
        PageRatingSchema
        description={
          "SIB Infotech offers top-notch database development solutions in Mumbai. Enhance your business with our tailored services. Contact us for a consultation today!"
        }
        reviewCount={"5178"}
      />
    </>
  ...
  return (
    <CustomLayout meta={metaTags}>
            ...
            <div className="col-lg-7 ps-lg-5">
              <div className="innerBannerTitle venter">
                ...
                <h2 className="small_heading fw-bold mt-3 text-white">
                  Top Rated Database Development Company in Mumbai,India
                </h2>
                <div className="mt-4">
      ...
      <div className=" d-lg-none">
        <Breadcrumb
          Pagetitle={"Database Development Services"}
        />
      </div>
