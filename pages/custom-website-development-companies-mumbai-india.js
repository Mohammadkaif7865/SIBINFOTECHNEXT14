            ...
            <div className="col-lg-7 ps-lg-5">
              <div className="innerBannerTitle venter">
                ...
                <h2 className="small_heading fw-bold mt-3 text-white">
                  Top Rated Custom Web Development Company in India
                </h2>
              ...
              <div className="bannerForm">
                ...
                <p>
                  ...
                  <strong className="fontWeight600 text_red">
                    Best{" "}
                    <span className="textChange">Custom Web Development </span>{" "}
                    Company in India
                  </strong>
                </p>
                <BannerForm />
      ...
      <div className="col-lg-5 d-block d-lg-none pe-lg-5">
        <div className="bannerForm">
          ...
          <p>
            with{" "}
            <strong className="fontWeight600 text_red">
              Best <span className="textChange">Custom Web Development </span>{" "}
              Company in India
            </strong>
          </p>
          <BannerForm />
          ...
          <div className="row align-items-center">
            <div className="col-lg-4">
              <h3 className="customHeading customLineHeight margin-bottom">
                It doesn't matter how small or big your company is we have{" "}
                <span className="text_red">Website Development</span> solutions
                for any size of the budget
              </h3>
              ...
              <div className="row">
                <div className="col-lg-6">
                  ...
                  <p className="customText">
                    SIB Infotech has been in business for several years in
                    excellent web creation development now and our PHP web
                    developers, ASP .Net programmers have extensive experience
                    in programming database and backend solutions for companies.
                    We develop advanced web applications that can handle mass
                    amounts of data and transactions.
                  </p>
                  <p className="customText">
                    We produce visually attractive, innovative and professional
                    designs, individually created to reflect the style, presence
                    and corporate identity of the Client
                  </p>
                  <img
                ...
                <div className="col-lg-6">
                  ...
                  />
                  <p className="customText">
                    company through our website development Services.
                  </p>
                  <p className="customText">
                    Apart from highly skilled Software Architects, Software
                    Engineers and web developers, our assemblage features
                    Visualizers, Web Developers, Web Graphic Designers, Quality
                    Assurance Analysts, Document Writers, Network Engineers,
                    Management, Finance &amp; Administrative Experts, Business
                    Development Managers, and others. We combine all these
                    skills with our management skills to provide our clients
                    with excellent end results. In all, we have a team exposed
                    to every possible software service and platform knowledge.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="row align-items-center">
            <div className="col-lg-8">
              <h3 className="customHeading">
                Hire your own{" "}
                <span className="text_red">Custom Web Development</span> Team
              </h3>
              <p className="customText">
                You can hire dedicated team of web developers from us according
                to your needs, on a monthly contract hire basis. A good
                experienced team of website developers will work dedicatedly for
                you,
              </p>
              <p className="customText">
                We offer real-time analytics, in-page analytics, market
                analysis, content auditing, competitor auditing, customer
                auditing, and influencer analysis. We also create “personas”,
                which is an effective way to understand the needs of your users
                while prioritizing the features and functionality of your
                personalized strategy for success. Some of the useful features
                within our analytics program include: custom filters, automated
                tasks, event tracking, funnel visualization, assisted
            ...
            <div className="col-lg-4">
              <div className="bgBlueDarkRight">
                <p className="customText text-white">
                  We believe that all good websites should be easy to find using
                  search engines and we have the expertise to create a website
                  design such that the webpages will be found on the major
                  search engines (search engine optimization). Marketing your
                  website is as important as good website design, and we can
      ...
      <section>
        <div className="containerFull">
          <h3 className="customHeading text-center">
            Web Application <span className="text_red">Development</span>
          </h3>
          <div className="row">
