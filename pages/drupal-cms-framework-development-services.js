...
export default function DrupalCmsDevelopmentServices() {
  const metaTags = (
    <>
      ...
      <meta property="og:image" content="https://www.sibinfotech.com/assets/og/drupal-cms-framework-development-services.webp" />
      ...
      <meta property="twitter:image" content="https://www.sibinfotech.com/assets/og/drupal-cms-framework-development-services.webp" />
      <BreadcrumbSchema
            ...
            <div className="col-lg-7 ps-lg-5">
              <div className="innerBannerTitle venter">
                ...
                <h2 className="small_heading fw-bold mt-3 text-white">
                  Top Rated Drupal CMS Development Company in India
                </h2>
                <div className="mt-4">
      ...
      <section>
        <div className="containerFull">
          <h3 className="customHeading customLineHeight text-center">
            If you are planning to develop the commercial website with the
            attractive designing and luring features then, apparently{" "}
            <span className="text_red">Drupal</span> would be the right
            selection for you!
          </h3>
          <div className="row mt-4">
            ...
            <div className="col-lg-6 ps-3 mt-5 mt-lg-0">
              <p className="customText">
                ...
                that encapsulates the PHP coding and is distributed under the
                General Public License.It is also used for knowledge management
                and business collaboration.
              </p>
              <p className="customText">
                SIB Infotech has earned its experience in Drupal web development
                services that includes Ecommerce websites, corporate websites,
                magazine websites etc. We are expert in Drupal Core and Module
                Customization. We are here to offer with the best customized web
                development services to our clients available in Drupal Module
                Community. We have also got our perfection over developing
                various new modules in Drupal to meet the specific business
                requirements of the clients.
              </p>
              <p className="customText">
                We have team of experienced drupal web developers which is
                capable of executing project of high technical challenge and
                complexity.
              </p>
              <p className="customText">
                You can also hire dedicated Drupal Web Developer, who will be
                working dedicatedly behind your project and will offer their
                100% on it.
              </p>
            </div>
          </div>
            ...
            <div className="col-lg-4">
              <div className="bgBlueDarkLeft">
                <h3 className="customHeading customLineHeight2 text-white">
                  Advantages of Drupal CMS Web Development
                </h3>
              </div>
            </div>
              ...
              <div className="row">
                <div className="col-lg-6">
                  <div className="drupal-box">
                    ...
                    />
                    <div>
                      <h4 className="margin-bottom">Flexibility</h4>
                      <p className="customText">
                        You can easily turn your drupal installation into a
                        forum, faq, blog, wiki and many other types of web sites
                      </p>
                    </div>
                  </div>
                </div>
                <div className="col-lg-6">
                  <div className="drupal-box">
                    ...
                    />
                    <div>
                      <h4 className="margin-bottom">Users &amp; Community</h4>
                      <p className="customText">
                        The large community guarantees that Drupal will have a
                        bright future
                      </p>
                    </div>
                  </div>
              ...
              <div className="row">
                <div className="col-lg-6">
                  <div className="drupal-box">
                    ...
                    />
                    <div>
                      <h4 className="margin-bottom">Easy to Install</h4>
                      <p className="customText">and Configure on live Server</p>
                    </div>
                  </div>
                </div>
                <div className="col-lg-6">
                  <div className="drupal-box">
                    ...
                    />
                    <div>
                      <h4 className="margin-bottom">Lots of features</h4>
                      <p className="customText">
                        such as custom search engine friendly URLs (SEF),
              ...
              <div className="row">
                <div className="col-lg-6">
                  <div className="drupal-box">
                    ...
                    />
                    <div>
                      <h4 className="margin-bottom">OpenSource</h4>
                      <p className="customText">
                        and Free to use &amp; customize
                      </p>
                    </div>
                  </div>
                </div>
                <div className="col-lg-6">
                  <div className="drupal-box">
                    ...
                    />
                    <div>
                      <h4 className="margin-bottom">Easily Integrable</h4>
                      <p className="customText">with third party application</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section>
        <div className="containerFull">
          <h3 className="customHeading text-center customLineHeight">
            At SIB Infotech, we provide following services in{" "}
            <span classname="text_red">Drupal CMS</span> Development
          </h3>
          <div className="row seriol-li">
            <div className="col-lg-6">
              <ul>
                <li className="customText margin-bottom">
                  Theme designing as per Business Requirement or Client idea
                </li>
                <li className="customText margin-bottom">
                  Theme design Conversion to Drupal
                </li>
                <li className="customText margin-bottom">
                  Installation and Configuration of Drupal on Server
                </li>
                <li className="customText margin-bottom">
            ...
            <div className="col-lg-6">
              <ul>
                <li className="customText margin-bottom">
                  Integration of Available Drupal Modules as per requirement
                </li>
                <li className="customText margin-bottom">
                ...
                <li className="customText margin-bottom">
                  Training of using Drupal Administrative panel
                </li>
              </ul>
            </div>
          </div>
