...
export default function Career() {
  const metaTags = (
    <>
      ...
      <meta
        name="description"
        content="Join SIB Infotech and grow your career in digital marketing. Explore exciting job opportunities, competitive benefits, and a dynamic work environment."
      />
      ...
      <meta
        property="og:title"
        content="Careers at SIB Infotech | Current Jobs Openings"
      />
      <meta
      ...
      <meta
        ...
        content="https://www.sibinfotech.com/career"
      />
      <meta
      ...
      <BreadcrumbSchema
        ...
        breadcrumbTitle="Careers at SIB Infotech | Current Jobs Openings"
      />
    </>
  );
  return (
          ...
          <div className="opening_wrap">
            ...
            <div className="opening_box">
              <div className="row">
                ...
                <div className="col-md-3">
                  <Link href="/apply-now">
                    <span className="theme-btn small-btn success-btn">
                      Apply Now
                    </span>
                  </Link>
                </div>
            ...
            <div className="opening_box">
              <div className="row">
                <div className="col-md-6">
                  <p className="title">
                    Accounts Eexcutive - Part Time Work From Home{" "}
                  </p>
                </div>
                <div className="col-md-3">
                  <p className="location">Delhi / Mumbai</p>
            ...
            <div className="opening_box">
              <div className="row">
                <div className="col-md-6">
                  <p className="title">
                    Business Development Executive Website Sales
                  </p>
                </div>
                <div className="col-md-3">
                  <p className="location">Delhi / Mumbai</p>
