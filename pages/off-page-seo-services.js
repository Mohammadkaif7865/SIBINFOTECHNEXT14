...
export default function OffPageSeoServices() {
  ...
  const faqDescription = `Build authority and trust for your website with
  ...
  const metaTags = (
    <>
      ...
      <meta
        property="og:url"
        content="https://www.sibinfotech.com/off-page-seo-services"
      />
      <meta
        property="og:title"
        content="Off-Page SEO Services | Quality Backlinks for Your Website"
      />
      <meta
  ...
  return (
    <CustomLayout meta={metaTags}>
      ...
      <div className="d-lg-none ">
        <Breadcrumb Pagetitle={"Off-Page SEO Services"} />
      </div>
          ...
          <div className="row">
            <div className="col-lg-7">
              <p className="customText">
                ...
                to drive the targeted traffic to your brand's website. It helps
                to acquire new leads, increases the quality and quantity of your
                ...
                crawlers understand that the website is valuable and worth as
                the brand and website are popular and trustworthy.
              </p>
              <p className="customText">
                ...
                We are amongst the top SEO companies in India.
              </p>
              <p className="customText">
            ...
            <div className="col-lg-6">
              <div className="off-page-seo-box">
                ...
                <p className="customText">
                  ...
                  indications of linked content quality. There are three types
                  of link that are mentored under link building.
                </p>
              </div>
            </div>
            <div className="col-lg-6">
          ...
          <div className="row">
            ...
            <div className="col-lg-4">
              <div className="off-page-seo-box">
                ...
                <p className="customText">
                  when relevant keywords are integrated in the website content,
                  it makes it far more attractive and useful for the audience
          ...
          <div className="row align-items-center">
            <div className="col-lg-7">
              ...
              <p className="customText text-center text-off-white">
                takes your brand to the top shelves of the digital world. With
                our expertise, experience, and excellence, we can help your
            ...
            <div className="col-lg-5 text-center">
              <p className="customText text-off-white">
                ...
                and getting the best placements for your website along with
          ...
          <div className="row align-items-center">
            <div className="col-lg-5">
              ...
              <p className="customText text-justify">
                ...
                'backlinks' and this plays a very important role in link
                building. Off-page optimization deals with regulating the
                backlinks on other publisher's pages including blogs, which
                leads to building a reliable spot on the search engine and the
                website rankings are set to the sky.
              </p>
              <p className="customText text-justify">
                The image of your business depends on its reputation and
                rankings on the search engines. There a plenty of benefits that
                a business attains from executing an off-page SEO strategy.
              </p>
              <p className="customText text-justify">
          ...
          <div className="row">
            <div className="col-lg-5">
              <div className="increaes-ranking-list">
                <ul>
                  <li>
                    <p className="customText">Market research and analysis</p>
                  </li>
                  <li>
                    <p className="customText">
                      Focusing on quality link building strategy
                    </p>
                  </li>
                  <li>
                    <p className="customText">
                      Creation of original, fresh and SEO optimized content
                    </p>
                  </li>
                  <li>
                    <p className="customText">
                      Building relations with industry influencers
                    </p>
                  </li>
                  <li>
                    <p className="customText">
                      Integrating natural and manual links
                    </p>
                  </li>
                  <li>
                    <p className="customText">
                      Guest post creation on numerous blogs and websites
                    </p>
                  </li>
                  <li>
                    <p className="customText">
                      Searching for broken links on the external platforms
                    </p>
                  </li>
                  <li>
                    <p className="customText">
                      Optimizing existing contents of the website
                    </p>
                  </li>
                  <li>
                    <p className="customText">Maintenance and support</p>
                  </li>
                  <li>
                    <p className="customText">Monthly progress reports</p>
                  </li>
                  <li>
                    <p className="customText">
            ...
            <div className="col-lg-7">
              <h3 className="customHeading">
                Increase Ranking from SIB{" "}
                <span className="text_red"> Off-Page SEO</span> services
              </h3>
              <p className="customText">
                We offer the best services that you can get for off-page
                optimization of your website. Building links if the ultimate key
                in off- page optimization and we build 100% spam free quality
                backlinks to website which have high quality relevant content.
              </p>
              <p className="customText">
                Our service can be the ultimate solution for your website to
                bring it to the top or most visited search results on the search
                engines.
              </p>
              <p className="customText">
          ...
          <div className="callAction">
            <div className="row">
              <div className="col-lg-8 offset-lg-2">
                <h3>
                  Are you ready to launch the #1 Off-page SEO strategy with the
