...
export default function SearchEngineOptimizationServices() {
  ...
  const serviceSchema = {
    ...
    serviceType: "SEO Service Company",
    url: "https://www.sibinfotech.com/search-engine-optimization-seo-services",
    description:
      "Enhance your online visibility and organic traffic with SIB Infotech, the best SEO company in India. Achieve lasting results with expert SEO services in Mumbai.",
    areaServed: {
      "@type": "Country",
      name: "India",
    },
