                ...
                <div className="rightMain stickyRight">
                  {activeTab === "section1" && (
                    <div className="itemSidebar scroll" id="section1">
                      ...
                      <p className="mt-3">
                        ...
                        rankings, increased traffic, and improved user
                        engagement.
                      </p>
                      <p className="mt-2">
                        ...
                        appearance. It includes the optimization of HTML tags
                        and images on the website of your brand.
                      </p>
                      <div className="row">
                  ...
                  {activeTab === "section2" && (
                    <div className="itemSidebar scroll" id="section2">
                      ...
                      <p className="mt-3">
                        ...
                        deals with the external links that direct traffic to
                        your websites organically, also known as 'backlinks'
                        This category deals with regulating the backlinks on
                        other publisher's pages including blogs, which leads to
                        building a reliable spot on the search engine and the
                  ...
                  {activeTab === "section4" && (
                    <div className="itemSidebar scroll" id="section4">
                      ...
                      <p className="mt-3">
                        ...
                        that is the technical parameters that directly affect
                        the visibility. It manages the technical set up of the
                        website that is the code. Most search engines prioritize
                        the website's code when ranking it for search engines.
                      </p>
                      <div className="row">
                        <div className="col-lg-6">
                          <ul className="listItems">
                  ...
                  {activeTab === "section5" && (
                    <div className="itemSidebar scroll" id="section5">
                      ...
                      <p className="mt-3">
                        ...
                        . We optimize product visibility, streamline the
                        shopping experience, and boost your sales. Elevate your
                        digital presence and make your products stand out in the
                  ...
                  {activeTab === "section6" && (
                    <div className="itemSidebar scroll" id="section6">
                      ...
                      <p className="mt-3">
                        Mobile SEO is based on its name, which is meant for
                        mobile devices. At present more than 60% of Google
                        searches are done on mobile phones. This{" "}
            ...
            <div className="col-lg-8">
              <div className="leftAction">
                <h4 className="sub_heading text-white fontHeading fontWeight500">
                  Are you ready to Expand Your Business online with our SEO
                  Services?
                </h4>
              </div>
            </div>
            <div className="col-lg-4">
              <div className="rightAction text-center">
                <Link href="#bannerSection" className="btnAction">
                  Speak with one of our SEO Experts in India today!
                </Link>
              </div>
            </div>
          </div>
                ...
                <div className="numberRight">
                  <div className="processHeader">
                    <h4 className="small_heading text_red fontHeading fontWeight600">
                      Website
                      <br className="d-none d-lg-block" /> Optimization
                    </h4>
                  </div>
                  <ul>
            ...
            <div className="col-lg-4 col-6 col-sm-4">
              <div className="itemSpecialization">
                <div className="iconSpecialization">
                  <picture>
                    <img
                      src="assets/images/icons/localseo.png"
                      alt="Local SEO"
                    />
                  </picture>
                </div>
          ...
          <div className="mt-3 row row-cols-2 row-cols-lg-5">
            <div className="col px-2 px-lg-3">
              <div className="newsLogo">
                <img
                  src="assets/images/news-logo/abc-news.webp"
                  alt="abc-news"
                />
              </div>
            </div>
            ...
            <div className="col px-2 px-lg-3">
              <div className="newsLogo">
                <img
                  src="assets/images/news-logo/buzzfeed.webp"
                  alt="buzzfeed"
                />
              </div>
            </div>
            ...
            <div className="col px-2 px-lg-3">
              <div className="newsLogo">
                <img
                  src="assets/images/news-logo/huffpost.webp"
                  alt="huffpost"
                />
              </div>
            </div>
          ...
          <div className="row align-items-center">
            <div className="col-lg-9">
              <div className="leftAction rightSpace">
                <h4 className="sub_heading text-white fontHeading fontWeight500">
                  80% of Customers will never look past the first search engine
                  results page.
                </h4>
              </div>
            </div>
            <div className="col-lg-3">
              <div className="rightAction text-center">
                <Link href="#bannerSection" className="btnAction w-100 mt-2">
                  Get to know how
                </Link>
              </div>
            </div>
                ...
                <div className="accordion" id="accordionExample2">
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingFiveteen">
                      ...
                      >
                        12. How do I choose a company for SEO?
                      </button>
                    </h2>
                    <div
                      id="collapseFiveteen"
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingSeventeen">
                      ...
                      >
                        14. Why Hire SEO Company in India?
                      </button>
                    </h2>
                    <div
