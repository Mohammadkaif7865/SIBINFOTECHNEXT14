            ...
            <div className="row mt-lg-4 mt-2 justify-content-center">
                ...
                <div className="teamItem">
                  <div className="teamImg">
                    <picture>
                      ...
                      <img
                        src="assets/images/team/abhishek-kumar-singh.jpg"
                ...
                <div className="teamItem">
                  <div className="teamImg">
                    <picture>
                      ...
                      <img
                        src="assets/images/team/aditya-kumar-jha.jpg"
                ...
                <div className="teamItem">
                  <div className="teamImg">
                    <picture>
                      ...
                      <img
                        src="assets/images/team/aishwarya-rao.jpg"
                        alt="Aishwarya Rao"
                      />
                    </picture>
                  </div>
                ...
                <div className="teamItem">
                  <div className="teamImg">
                    <picture>
                      ...
                      <img
                        src="assets/images/team/anup-kumar.jpg"
                        alt="Anup Kumar"
                      />
                    </picture>
                  </div>
                ...
                <div className="teamItem">
                  <div className="teamImg">
                    <picture>
                      ...
                      <img
                        src="assets/images/team/ashutosh-kumar-singh.jpg"
                        alt="Aditya Kumar Jha"
                      />
                    </picture>
                  </div>
                ...
                <div className="teamItem">
                  <div className="teamImg">
                    <picture>
                      ...
                      <img
                        src="assets/images/team/geordy-mathew.jpg"
                        alt="Geordy Mathew"
                      />
                    </picture>
                  </div>
                ...
                <div className="teamItem">
                  <div className="teamImg">
                    <picture>
                      ...
                      <img
                        src="assets/images/team/harshal-shetty.jpg"
                        alt="Harshal Shetty"
                      />
                    </picture>
                  </div>
                ...
                <div className="teamItem">
                  <div className="teamImg">
                    <picture>
                      ...
                      <img
                        src="assets/images/team/hemang-sharma.jpg"
                        alt="Hemang Sharma"
                      />
                    </picture>
                  </div>
                ...
                <div className="teamItem">
                  <div className="teamImg">
                    <picture>
                      ...
                      <img
                        src="assets/images/team/kanchan-sharma.webp"
                        alt="Kanchan Sharma"
                      />
                    </picture>
                  </div>
                ...
                <div className="teamItem">
                  <div className="teamImg">
                    <picture>
                      ...
                      <img
                        src="assets/images/team/mahadev-prasad-uniyal.jpg"
                ...
                <div className="teamItem">
                  <div className="teamImg">
                    <picture>
                      ...
                      <img
                        src="assets/images/team/malini-guria.jpg"
                        alt="Malini Guria"
                      />
                    </picture>
                  </div>
                ...
                <div className="teamItem">
                  <div className="teamImg">
                    <picture>
                      ...
                      <img
                        src="assets/images/team/mohammad-kaif.jpg"
                        alt="Mohammad Kaif"
                      />
                    </picture>
                  </div>
                ...
                <div className="teamItem">
                  <div className="teamImg">
                    <picture>
                      ...
                      <img
                        src="assets/images/team/mumtaz-alam.jpg"
                        alt="Mahadev Prasad Uniyal"
                      />
                    </picture>
                  </div>
                ...
                <div className="teamItem">
                  <div className="teamImg">
                    <picture>
                      ...
                      <img
                        src="assets/images/team/nikita-awle.jpg"
                        alt="Nikita Awle"
                      />
                    </picture>
                  </div>
                ...
                <div className="teamItem">
                  <div className="teamImg">
                    <picture>
                      ...
                      <img
                        src="assets/images/team/niti-chopra.jpg"
                        alt="Niti Chopra"
                      />
                    </picture>
                  </div>
                ...
                <div className="teamItem">
                  <div className="teamImg">
                    <picture>
                      ...
                      <img
                        src="assets/images/team/pooja-sharma.jpg"
                        alt="Pooja Sharma"
                      />
                    </picture>
                  </div>
                ...
                <div className="teamItem">
                  <div className="teamImg">
                    <picture>
                      ...
                      <img
                        src="assets/images/team/raghunath-samal.jpg"
                        alt="Raghunath Samal"
                      />
                    </picture>
                  </div>
                ...
                <div className="teamItem">
                  <div className="teamImg">
                    <picture>
                      ...
                      <img
                        src="assets/images/team/rakesh-durkar.jpg"
                        alt="Rakesh Durkar"
                      />
                    </picture>
                  </div>
                ...
                <div className="teamItem">
                  <div className="teamImg">
                    <picture>
                      ...
                      <img
                        src="assets/images/team/reema-bhange.jpg"
                        alt="Reema Bhange"
                      />
                    </picture>
                  </div>
                ...
                <div className="teamItem">
                  <div className="teamImg">
                    <picture>
                      ...
                      <img
                        src="assets/images/team/rekha-singh.jpg"
                        alt="Rekha Singh"
                      />
                    </picture>
                  </div>
                ...
                <div className="teamItem">
                  <div className="teamImg">
                    <picture>
                      ...
                      <img
                        src="assets/images/team/sandra-vattoly.jpg"
                        alt="Sandra Vattoly"
                      />
                    </picture>
                  </div>
                ...
                <div className="teamItem">
                  <div className="teamImg">
                    <picture>
                      ...
                      <img
                        src="assets/images/team/santosh-kumar.jpg"
                        alt="Santosh Kumar"
                      />
                    </picture>
                  </div>
              ...
              <div className="col-lg-3 col-6 px-lg-4">
                <div className="teamItem">
                  <div className="teamImg">
                    <picture>
                      <source srcSet="assets/images/team/tushar.jpg" />
                      <img
                        src="assets/images/team/tushar.jpg"
                        alt="Tushar Lad"
                      />
                    </picture>
                  </div>
                ...
                <div className="teamItem">
                  <div className="teamImg">
                    <picture>
                      ...
                      <img
                        src="assets/images/team/vishakha.jpg"
                        alt="Vishakha"
                      />
                    </picture>
                  </div>
                ...
                <div className="teamItem">
                  <div className="teamImg">
                    <picture>
                      ...
                      <img
                        src="assets/images/team/vishal-maurya.jpg"
                        alt="Vishal Maurya"
                      />
                    </picture>
                  </div>
                ...
                <div className="teamItem">
                  <div className="teamImg">
                    <picture>
                      ...
                      <img
                        src="assets/images/team/zaroon-junaid.jpg"
                        alt="Zaroon Junaid"
                      />
                    </picture>
                  </div>
