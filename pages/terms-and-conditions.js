  ...
  return (
    <div>
        <Head>
            ...
            <link rel="canonical" href="http://157.245.98.188/terms-and-conditions"/>
        </Head>
			        ...
			        <div className="col-lg-12">
    					<div className="innerBannerTitle venter">
                            ...
                            <div className="mt-5 text-center">
                                <Link href="http://157.245.98.188/#requestQuote" className="btnThemeRed me-3"><i className="fa-solid fa-comment-dots"></i> Get a Quote</Link>
