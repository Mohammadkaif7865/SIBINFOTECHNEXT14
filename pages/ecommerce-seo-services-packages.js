            ...
            "@graph": [
              {
                ...
                description:
                  "Affordable E-Commerce SEO packages by SIB Infotech to boost online business traffic, improve rankings and increase conversions.",
                provider: {
                ...
                serviceType: "E-commerce SEO Packages",
              },
              {
                "@type": "Organization",
                "@id": "https://www.sibinfotech.com/#organization",
              ...
              <div className="bannerForm">
                ...
                <p>
                  ...
                  <strong className="fontWeight600 text_red">
                    Best{" "}
                    <span className="textChange">E-commerce Seo Packages</span>{" "}
                    Company in India
                  </strong>
                </p>
                <BannerForm />
      ...
      <div className="col-lg-5 d-block d-lg-none pe-lg-5">
        <div className="bannerForm">
          ...
          <p>
            with{" "}
            <strong className="fontWeight600 text_red">
              Best <span className="textChange">E-commerce Seo Packages</span>{" "}
              Company in India
            </strong>
          </p>
          <BannerForm />
                    ...
                    <table className="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td data-label="Start Up">10</td>
                          <td data-label="Grow">20</td>
                          <td data-label="Enterepreneur">30</td>
                          <td data-label="Wantrepreneur">50</td>
                          <td data-label="Custom">TBD</td>
                          <td data-label="Pricing">
                            <Link
                              className="package-btn"
                        ...
                        <tr>
                          <td data-label="Key phrases to be Optimized">
                            On-page Crawl Error Correction (Dynamic: Recommended
                            to Client)
                          </td>
                          <td data-label="Self Employed">
                            <i className="fa fa-check checkIcon"></i>
