                ...
                <div className="row">
                    <div className="col-lg-7 ps-lg-5">
                        <div className="innerBannerTitle venter">
                            <h1 className="heading fontWeight700  fontHeading text-white">Website Analysis & Tracking Reports</h1>
                            <h2 className="small_heading fw-bold mt-3 text-white">Top Rated Website Analysis &amp; Tracking Reports Company in India</h2>
                            <div className="mt-4">
