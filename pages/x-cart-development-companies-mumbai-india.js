                 ...
                 <div className="row">
			        <div className="col-lg-7 ps-lg-5">
    					<div className="innerBannerTitle venter">
    						<h1 className="heading fontWeight700 text-white">X-cart Development Services</h1>
                <h2 className="small_heading fw-bold mt-3 text-white">Top X-Cart Development Company in Mumbai, India</h2>
