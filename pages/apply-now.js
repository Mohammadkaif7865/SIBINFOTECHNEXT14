                 ...
                 <div className="row">
			        <div className="col-lg-12">
    					<div className="innerBannerTitle venter">
                            ...
                            <p className="small_heading mt-3 text-center text-white">We’re a team of lifelong learners. We’re equal parts left and right brained. Join Us!</p>
                            <p className="title mt-2 text-white text-center">Connect with our HR Department </p>
                                         ...
                                         <div className="apply_form_box expdiv">
                                             ...
                                             return (
                                               ...
                                               <div className="row">
                                                       ...
                                                       {(index == 0) ? (
                                                       <div className="col-md-12">
                                                           <span className="addMore web_btn btnAdd" onClick={addExperienceField}><i className="fa fa-plus"></i> Add more</span>
                                                       </div>
                                                     ) : (
                                                       <div className="col-md-12">
                                                           <span className="web_btn removeBtn" onClick={() => removeExperienceField(index)}><i className="fa fa-times"></i> Remove</span>
                                                       </div>
                                                     ) }
