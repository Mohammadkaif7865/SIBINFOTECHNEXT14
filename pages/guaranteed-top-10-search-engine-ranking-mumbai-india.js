            ...
            <div className="col-lg-7 ps-lg-5">
              <div className="innerBannerTitle venter">
                <h3 className="heading fontWeight700 text-white">
                  Guaranteed Top 10 Search Engine Rankings
                </h3>
                <div className="mt-4">
                ...
                <p>
                  ...
                  <strong className="fontWeight600 text_red">
                    ...
                    <span className="textChange">
                      Search Engine Rankings Company
                    </span>{" "}
                    Company in India
                  </strong>
                </p>
      ...
      <div className="col-lg-5 d-block d-lg-none pe-lg-5">
        <div className="bannerForm">
          ...
          <p>
            ...
            <strong className="fontWeight600 text_red">
              Best{" "}
              <span className="textChange">Search Engine Rankings Company</span>{" "}
              Company in India
            </strong>
          </p>
          <BannerForm />
          ...
          <div className="row">
            <div className="col-lg-5">
              <div className="seo-results-heading-section bgWhite">
                <h2 className="customHeading customLineHeight2">
                  <span>SEO</span> helps increase your business prospects and
                  with proper <span>SEO </span>services you can give your
                  business a boost that is not possible with any other marketing
                  technique
                </h2>
              </div>
            </div>
            <div className="col-lg-7">
              <p className="customText">
                ...
                popularity of your business over the internet.SEO Outsourcing
                India makes sure that your business gets the top ten SEO
                rankings, the best of clients and maximum benefits.
              </p>
              <p className="customText">
                We provide you with the best strategies to take your business to
                the top ten SEO rankings. Guaranteed top ten ranking is what you
                can expect for your business with us.
              </p>
              <p className="customText">
                SIB InfoTech’s top 10 ranking report show up Google’s ranking
                algorithm and let you know in clear words how to optimize and
                arrange your website purposely for improved results in Google.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="containerFull">
          ...
          <div className="seo-results-row">
            <div className="seo-results-process-box">
              <span>1</span>
              <p className="customText">
                Decide what keywords you want to rank for and submit a free SEO
                quote request.
              </p>
            ...
            <div className="seo-results-process-box">
              <span>2</span>
              <p className="customText">
                We will get back to you within 1 business day with a customized
                price quote. Our rates start at $500 per month for a top 10
                ranking.
              </p>
              <div className="step-line"></div>
            </div>
            <div className="seo-results-process-box">
              <span>3</span>
              <p className="customText">
                If you accept our quote, we require 50% (of the monthly fee
                quoted) as a deposit.
              </p>
            </div>
          </div>
          <div className="seo-results-second-row">
            <div className="seo-results-process-box lg-width margin-right">
              <span>5</span>
              <p className="customText">
                Once we achieve top 10 rankings we will request your full
                recurring monthly fee. If for some reason we fail to achieve
                first page rankings within 12 weeks we will refund 100% of your
                deposit.
              </p>
              <div className="step-line"></div>
            </div>
            <div className="seo-results-process-box margin-right">
              <span>4</span>
              <p className="customText">We begin working on your project.</p>
