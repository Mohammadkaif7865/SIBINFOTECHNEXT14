            ...
            <div className="col-lg-7 ps-lg-5">
              <div className="innerBannerTitle venter">
                ...
                <h2 className="small_heading fw-bold mt-3 text-white">
                  Top Rated CRM Development Company in India
                </h2>
                <div className="mt-4">
      ...
      <section>
        <div className="containerFull">
          <h3 className="customHeading customLineHeight text-center">
            <span>Customer Relationship Management</span> (CRM) covers all
            aspects of the company’s relationship with its customers.
          </h3>
          <div className="row">
            ...
            <div className="col-lg-6">
              <p className="customText">
                The today’s highly-computerized world is changing the buyers’
                behavior and thus calls for new approaches in building corporate
                CRM strategies. With the advance of new selling channels due to
                popularization of WWW and mobile devices special emphasis is put
                on self-service tools, electronically-managed relationships and
                personalization of online consumer experience.
              </p>
              <p className="customText">
                We specialize in providing our customers with complete CRM. Our
                experienced consultants have considerable experience in
                different aspects of building an effective CRM system.
              </p>
              <p className="customText">
                In-depth understanding of all aspects of the CRM software
                implementation combined with strong technical expertise enable
                us to deliver CRM solutions fully customized to client’s
                requirements and business specifics. We will help you to enhance
                your existing information sharing and sales system enabling you
                to build highly effective channels for exchanging information
                with your customers, suppliers and employees worldwide based on
            ...
            <div className="col-lg-4">
              <div className="bgBlueDarkLeft bgBlueDarklgHeight">
                <h3 className="customHeading text-white customLineHeight2">
                  We will guide you through all the stages of the solution
                  implementation giving a sound advice and helping you
                </h3>
          ...
          <div className="row align-items-center">
              ...
              <div className="row">
                ...
                <div className="col-lg-4">
                  <ul className="square-li">
                    ...
                    <li className="customText">Catalog Management</li>
                  </ul>
                </div>
                <div className="col-lg-4">
                  <ul className="square-li">
                    ...
                    <li className="customText">Customer Support Tools</li>
                    <li className="customText">
            ...
            <div className="col-lg-4">
              <h3 className="customHeading customLineHeight2">
                Our experts will help you understand all the implementation
                possibilities and help you select the right components of the
                future <span className="text_red">CRM System </span>that are
          ...
          <div className="row align-items-center">
            <div className="col-lg-7">
              <p className="customText text-white text-center">
                Our team has immense expertise in customizing CRM solutions for
                your business using the following 2 Open Source Software
              </p>
              <p className="customText text-white text-center mt-2">
                At SIB Infotech we understand that the success is not only the
                right technology, it’s the right understanding of your business
                powered with the right technological solution.
              </p>
            </div>
