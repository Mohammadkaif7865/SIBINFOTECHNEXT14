...
export default function WindosMobileApplicationDevelopementServices() {
  const metaTags = (
    <>
      ...
      <meta property="og:image" content="https://www.sibinfotech.com/assets/og/windows-mobile-application-development-services.webp" />
      ...
      <meta property="twitter:image" content="https://www.sibinfotech.com/assets/og/windows-mobile-application-development-services.webp" />
      <BreadcrumbSchema
                 ...
                 <div className="row">
			        <div className="col-lg-7 ps-lg-5">
    					<div className="innerBannerTitle venter">
    						<h1 className="heading fontWeight700 fontHeadingtext-white">Windows Mobile Application Development</h1>
                            <h2 className="small_heading fw-bold mt-3 text-white">Top Rated Windows Mobile Application Development Company in India</h2>
    						<div className="mt-4">
