    ...
    <div className="containerFull marketing_hero_main bgsection_m1 overflow-hidden ">
      <div className="row  marketing_hero">
        <div  data-aos="fade-right" className="col-lg-6">
          ...
          Your <span  className="text_red">Complete WhatsApp Engagement</span> Platform
          </h1>
          ...
          <div class="mt-4"><a href="/contact-us"><span class="btnThemeRed2 fontWeight600 me-3"><i class="fa-solid fa-comment-dots"></i> Get a Quote</span></a><a href="/contact-us"><span class="btnThemeRed3 fontWeight600"><i class="fa-solid fa-circle-question"></i> Ask a Question</span></a></div>
        </div>
        <div className="col-lg-6">
          <div className="position-relative  marketing_hero_right ">

          <Image className="" fill quality={100}  src={"/assets/images/Mobile Marketing.gif"} alt={""} />
