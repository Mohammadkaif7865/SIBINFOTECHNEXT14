        ...
        <div className="row mt-5">
          <div className="col-lg-4 mb-3  position-relative">
            <div className="why_left_item">
              <h4 className="fontHeading2 fontWeight600 text_red">Why SIB Infotech</h4>
              <h5 className=" mt-3 large_heading2 fontHeading2 fontWeight600">
                in a nutshell<span className="text_red">.</span>
              </h5>
              <div className="why_left_card mt-4">
                <h4 className="fontHeading2 fontWeight600 ">
                ...
                <button className="p-2 mt-4 w-100 bg-black text-white">
                  Get a Free Analysis
                </button>
              </div>
            </div>
          ...
          <div className="col-lg-8">
            <h5 className="fontHeading2 fontWeight500 text_red sub_heading ps-4">
            ...
            <p className="mt-3 ps-4">
              ...
              execute campaigns—we create impactful, data-driven strategies that
