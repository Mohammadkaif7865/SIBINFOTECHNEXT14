...
const DigitalMarketingServices = dynamic(() => import("./DigitalMarketingServices"));
const AboutUs = dynamic(() => import("./AboutUs"));
const DigitalMarketingWebAgency = dynamic(() => import("./DigitalMarketingWebAgency"));
const DigitalMarketingAgency = dynamic(() => import("./DigitalMarketingAgency"));
