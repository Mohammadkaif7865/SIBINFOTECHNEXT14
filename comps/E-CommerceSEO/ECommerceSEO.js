...
import WhyEcCrucial from "./WhyEcCrucial";
import WhatWeDo from "./WhatWeDo";
import Contact from "../InstagramAdsMgt/Contact";
import ECStrategy from "./ECStrategy";
...
const ECommerceSEO = () => {
  return (
    <>
          ...
          <div className="row">
            <div className="col-lg-6">
              <p className="customText text-justify">
                ...
                Result Pages) when the audience searches for products and
                services that your company sells. The agenda accomplished
                through e-Commerce SEO is simple; the higher the page rank, the
                higher is the traffic engagement on your webpage.
              </p>
              <p className="customText text-justify">
                What does a user do when they require a specific product or
                service? A majority of them go through Google searches to look
                for options, tips along with useful information that helps them
                to decide which option they need. If a website fails to reach
                the top SERPs it loses the advanced reach to interested
                customers.
              </p>
              <p className="customText">
                ...
                website, display and mesmerize them with high-quality products
                and intriguing offers motivating them to buy your services.
              </p>
              <p className="customText">
                ...
                increase organic traffic to your web store or e-Commerce
                website. SEO tools are beneficial for all the businesses might
                it be an online shopping company or a market business.
              </p>
              <p className="customText">
                ...
                descriptions, metadata, internal link structure, etc. It adds
                all the crucial offers and products to the website and includes
                the promotion of your store on social media platforms.
              </p>
            </div>
            <div className="col-lg-6">
              <img
          ...
          <div className="row">
            <div className="col-lg-6">
              <h3 className="customHeading">
                <span className="text_red">E-Commerce SEO </span>is crucial for
                your website
              </h3>
              <p className="customText">
                The digital world growing at a very fast rate leading to rapid
                growth in the e-Commerce existence of the businesses. Today, the
                competition is at its peak and every company wants to establish
                a lost lasting domain in the online retail market. The ultimate
                goal of our e-Commerce SEO service is to ensure enough organic
                footing of your business so that it yields high revenue along
                with long-lasting existence on the online marketplace.
              </p>
              <p className="customText">
                If your company does not have a strong E-commerce seo strategy
                you are bound to lose visibility on google search resulting to
                less impressions, clicks and sales.
              </p>
            </div>
            <div className="col-lg-6">
              <p className="customText">
              ...
              <p className="customText">
                ...
                their business completely on their websites. The e-Commerce
                optimization of your website plays a very dominating part in
                growing your audience, customer base, traffic, and sales.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="containerFull">
          <div className="row align-items-center">
            <div className="col-lg-3 crucial-list">
              <ul>
                <li>
                  <p className="customText text-white">Increases conversions</p>
                </li>
                <li>
                ...
                <li>
                  <p className="customText text-white">Boosts sales</p>
                </li>
                <li>
                  <p className="customText text-white">
            ...
            <div className="col-lg-6">
              <p className="customText text-white">
                The e-Commerce sector is huge, so the SEO optimization seeks for
                expertise and strategies crafted with experienced minds. At SIB
                Infotech we have a separate E-commerce SEO team of extremely
                experienced experts who can optimize your website in such a way
                that you never require paid advertising anymore to boost your
                sales and build a reputation.
              </p>
              <p className="customText text-white">
                Your business needs to hire a reliable e-Commerce SEO agency to
                yield high-quality and measurable results. SIB is the best SEO
                company in India that can provide your business sky-touching
                results after employing our e-Commerce SEO strategies.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="col-lg-6">
              <div className="off-page-seo-box extra-height">
                <div className="off-page-seo-box-heading">
                  ...
                  <h4>e-Commerce Keyword Research</h4>
                </div>
                <p className="customText">
              ...
              <div className="col-lg-6">
                <div className="off-page-seo-box extra-height">
                  <div className="off-page-seo-box-heading">
                    ...
                    <h4>Schema mark-ups</h4>
                  </div>
                  <p className="customText">
                    the schema mark-ups are responsible to provide information
                    to the searcher which could increase your CTR by 30%. The
                    search engines use the schema information to understand the
                    website content, it is used to identify the content of the
                    page such as if it is a category page, products page, or
                    blog post or something else. This info plays an important
                    role in increasing the website’s ranking as search engines
              ...
              <div className="col-lg-6">
                <div className="off-page-seo-box extra-height">
                  <div className="off-page-seo-box-heading">
                    ...
                    <h4>Strategical internal linking</h4>
                  </div>
                  <p className="customText">
                    internal links on your website drive customers to explore
                    more of your products. These internal links should be
                    relevant to the choices or pages the customer is browsing.
                    Internal links help you to boost specific pages or products
                    which also enhances the ranking of the products on the
                    search engines.
                  </p>
                </div>
              </div>
      ...
      <WhatWeDo />
      <Contact
        heading="Launch your E-Commerce SEO strategy"
        subheading="with the Top E-commerce SEO company in India with offices in
        Mumbai and Delhi"
        buttonText=" Talk to our e-Commerce SEO Experts "
        buttonLink="/contact"
        isPBeforeH3={false}
      />
            ...
            <div className="col-lg-7">
              <div className="section-4-left">
                <h3 className="customHeading text-white">
                  Launch your E-Commerce SEO strategy
                </h3>
                <p className="customText text-white">
                  with the Top E-commerce SEO company in India with offices in
                  Mumbai and Delhi
                </p>
              </div>
            </div>
            <div className="col-lg-5">
              <div className="section-4-right">
                <Link className="customBtn" href="/contact-us">
                  Talk to our e-Commerce SEO Experts
                </Link>
              </div>
            </div>
          </div>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6">
              <h3 className="customHeading mt-4">
                <span className="text_red">E-Commerce optimization</span>{" "}
                strategy at SIB Infotech
              </h3>
              <p className="customText">
              ...
              <p className="customText">
                SEO has the foremost progressive impact on the organic
                visibility of your e-Commerce website, but it is crucial to
                choose a professional and reliable SEO agency that has the
                solution to all problems of the search engine algorithms
                alongside experience in delivering flexible services and
                results.
              </p>
              <p className="customText">
            ...
            <div className="col-lg-4">
              <div className="list-box">
                <ul>
                  ...
                  <li>
                    <p className="customText">E-commerce SEO Audit</p>
                  </li>
                  <li>
                    <p className="customText">
            ...
            <div className="col-lg-4">
              <div className="list-box">
                <ul>
                  ...
                  <li>
                    <p className="customText">Competitor research</p>
                  </li>
                  <li>
                    <p className="customText">Shop's structure optimization</p>
                  </li>
                  <li>
                    <p className="customText">
                  ...
                  <li>
                    <p className="customText">Category page optimization</p>
                  </li>
                  <li>
                    <p className="customText">Products page optimization</p>
                  </li>
                </ul>
              </div>
            </div>
            <div className="col-lg-4">
              <div className="list-box">
                <ul>
                  ...
                  <li>
                    <p className="customText">Sale Funnel Optimization</p>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="row align-items-center">
            <div className="col-lg-8 blueBg graphic-why-us-right">
              <h3 className="customHeading text-white customLineHeight">
                Pro-active experience with a diverse range of e-Commerce
                platforms
              </h3>
              <p className="customText text-off-white">
                Our SEO experts and developers have paralleled with a variety of
                e-Commerce platforms, be it open-source or hosted. Such
                experience enables us to provide your company platform-specific
                SEO consultations even on short notices.
              </p>
              <p className="customText text-off-white">
              ...
              <p className="customText text-off-white">
                ...
                clients who availed our e-Commerce SEO solutions, and we know
                that we can do the same for your business.
              </p>
              <p className="customText text-off-white">
                In case you want to try our services and ensure what we can do
                for you, claim a free no-obligation SEO audit right now!
              </p>
            </div>
            <div className="col-lg-4">
        ...
        <div class="containerFull">
          <div class="row">
            <div class="col-lg-12">
              ...
              <h4 class="text-center">Few of many are listed :</h4>
              <div class="row mt-4">
        ...
        <div className="containerFull">
          <div className="row align-items-center">
            <div className="col-lg-6 order-2 order-lg-1 mt-2 mt-lg-0">
              <h3 className="customHeading">
                Why do I need an{" "}
                <span className="text_red">e-Commerce SEO </span>expert?
              </h3>
              <p className="customText">
