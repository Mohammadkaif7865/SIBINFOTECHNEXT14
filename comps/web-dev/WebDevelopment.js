  ...
  const faqsData = [
    {
      ...
      answer: `<div className="accordion-body"><p>Website development is the process of building the technical and functional parts of a website, including frontend and backend code, databases, integrations, hosting, security, and other systems.</p></div>`,
    },
    {
      id: "faq2",
      question: "What is a website?",
      answer: `<div className="accordion-body"><p>A website is a collection of related web pages hosted on a server and accessed through a domain name. Businesses use websites to provide information, sell products or services, and generate leads.</p></div>`,
    },
    {
      id: "faq3",
      question: "How do I choose a web development company?",
      answer: `<div className="accordion-body"><p>Review the company's portfolio, relevant experience, client feedback, development approach, security practices, technology choices, post-launch support, and pricing.</p></div>`,
    },
    {
      id: "faq4",
      question: "What does a web development company do?",
      answer: `<div className="accordion-body"><p>A web development company builds and maintains the functional parts of websites, including frontend and backend development, databases, integrations, security, hosting, and technical support.</p></div>`,
    },
    {
      id: "faq5",
      question: "How much does it cost to develop a website?",
      answer: `<div className="accordion-body"><p>Website development costs vary based on design, features, technology, integrations, number of pages, and maintenance requirements.</p></div>`,
    },
    {
      id: "faq6",
      question: "What is the difference between a website and a web application?",
      answer: `<div className="accordion-body"><p>A website mainly provides information or content, while a web application provides interactive functionality such as logins, bookings, data management, or transactions.</p></div>`,
    },
  ];
