          ...
          <div className="row align-items-center">
            <div className="col-12 col-lg-9">
              ...
              <p className="text-white mb-0">
                From Search and Shopping to YouTube, Remarketing, and Performance
                Max — every Google Ads format your business needs, fully managed
                by certified SIB Infotech specialists.
              </p>
            </div>
        ...
        <div className="seoMana">
          <div className="row">
            <div className="col-lg-4">
              <div className="sidebarService stickyRow" ref={sidebarRef}>
                <ul>
