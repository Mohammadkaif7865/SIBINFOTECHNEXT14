            ...
            <div className="col-md-7">
              <div className="rightPPC">
                ...
                <p className="customText">
                  ...
                  record to take your PPC campaigns to the next level and
                  provide you with integrated, adverting and marketing solution.
                </p>
                <p className="customText">
                ...
                <p className="customText">
                  ...
                  advertiser run an ad and he will get charged if there will be
                  a click on his ad. Advertiser pay a fees every time on his ad
        ...
        <div className="containerFull">
          ...
          <div className="customRow ppcRow mob_row">
            ...
            <div className="columnRow">
              <div className="iconAdd">
                <img
                  src="assets/images/icons/amazon-ads.png"
                  alt="Amazon Ads"
                />
              </div>
              <h3>Amazon Ads</h3>
              ...
              <div className="row">
                <div className="col-lg-6">
                  <div className="itemPayper">
                    ...
                    <p>
                      In order to run a successful PPC campaign its very
                      important to put effective and relevant keywords.
                    </p>
                  </div>
                </div>
                <div className="col-lg-6">
                  <div className="itemPayper">
                    ...
                    <p>
                      Advertiser with better quality score get maximum clicks
                      with lower cost.
                    </p>
                  </div>
                </div>
            ...
            <div className="col-lg-4">
              <div className="beniftsDigi">
                <ul>
                  ...
                  <li>
                    It provide your brand a good exposer in front of right
                    people.
                  </li>
                  <li>
