  ...
  const power_data = [
    {
      ...
      description: "With a long-standing partnership with Google, we stay up-to-date with the latest PPC trends and tools.",
    },
    {
      title: "Tailored Campaigns",
      description: "We don’t believe in one-size-fits-all. Every PPC campaign we manage is uniquely designed for your business.",
    },
    {
      title: "Data-Driven Results",
      description: "Our strategies are backed by data, ensuring your ad spend is optimized for maximum returns.",
    },
    {
      title: "Transparent Reporting",
      description: "Stay in the loop with detailed reports on your PPC campaign’s performance.",
    },
    {
      title: "Maximize ROI",
      description: "We focus on delivering high conversions at the lowest possible cost to maximize your return on investment.",
    },
    {
      title: "Cross-Platform Expertise",
      description: "From Google Ads to Facebook, Instagram, and YouTube — we manage PPC campaigns across all major platforms.",
    },
  ];
