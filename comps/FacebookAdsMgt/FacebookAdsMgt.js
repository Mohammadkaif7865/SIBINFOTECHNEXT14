            ...
            <div className="col-lg-7">
              <div className="section-4-left">
                <h3 className="customHeading text-white">
                  Our experts make sure that your brand gets the limelight
                </h3>
                <p className="customText text-white">
                  of a major proportion of the audience.
                </p>
              </div>
            </div>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6">
              ...
              <p className="customText">
                ...
                India, our services assure that your brand gets the best
                possible publicity. Our Facebook advertising strategy is an
                ultimate blend of all the tools and tactics that can set your
                sales on fire. We make sure that the ads drive traffic to your
                website and take your sales to the next level. We have
                360-degree Facebook advertising strategy to help your business
                grow with facebook advertising.
              </p>
              <p className="customText">
                ...
                comparison to facebook. Facebook allows customer targeting
                options that enable a business to find any category of users,
                might it be a large, small, or niche audience. These benefits
                are accompanied by complexities and to gain the maximum
                throughput from a Facebook advertising campaign your business
                needs experienced and skills minds and this is where our
                expertise is there.
              </p>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-lg-6">
              ...
              <p className="customText">
                ...
                to target a huge volume of users by estimating who they are,
                what activities they do online along with their interests. It is
                an ultimate platform for lead generation as well as direct
                sales, as it is a stage where you can directly confront the
                potential customers at the place where they spend a major
            ...
            <div className="col-lg-6">
              ...
              <p className="customText">
                Facebook is an ultimate platform for any business to showcase
                its services and acquire a huge audience in a very short period.
          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="facebook-ads-benefit-box">
                <h3 className="customHeading">Identify target audience</h3>
                <p className="customText">
                  Determining the target audience is a very important part of
                  Facebook marketing because you are going to establish your
                  brand value into their mind. We always keep a few points in
                  mind while deciding the target audience,
                </p>
            ...
            <div className="col-lg-6">
              <div className="facebook-ads-benefit-box">
                <h3 className="customHeading">Competitor content analysis</h3>
                <p className="customText">
                  we find it to be very important in the competition that we
                  analyze and keep track that what your competitors are doing.
                  Few below things you should always keep in the mind
                </p>
                <ul className="facebook-ads-benefit-list">
                  <li className="customText">
                    What kind of hashtags they are using?
                  ...
                  <li className="customText">
                    How frequently do they respond to their comments?w
                  </li>
                </ul>
              </div>
            </div>
      ...
      {/* <section>
        <div className="containerFull">
          ...
          <p className="customText text-center">
            ...
            content for your advertisements. We make sure that the content
            follows the market trend and is attractive.
          </p>
          <div className="row">
            <div className="col-lg-4">
              <div className="ad-content-box">
                <img
                  src="assets/images/icons/facebook-ads-managemnet-pre-schedul-planning.svg"
                  alt="facebook-ads-managemnet-pre-schedul-planning"
                />
                <h4>Pre-plan schedule</h4>
                <p className="customText">
                  After crafting highly effective content, we find it very
                  important to decide when and how often it should be published.
                </p>
              </div>
            </div>
            <div className="col-lg-4">
              <div className="ad-content-box">
                <img
                  src="assets/images/icons/faceboog-ads-manegemnet-progress-tracking.svg"
                  alt="facebook-ads-management-progress-tracking"
                />
                <h4>Progress tracking</h4>
                <p className="customText">
                  It is very important to track the performance of the campaign
                  from time to time.
                </p>
              </div>
            </div>
            <div className="col-lg-4">
              <div className="ad-content-box">
                <img
                  src="assets/images/icons/facebook-ads-management-transparent-report.svg"
                  alt="facebook-ads-management-transparent-report"
                />
                <h4>Transparent reports</h4>
                <p className="customText">
                  We send you transparent progress reports monthly so that you
                  can track and record the outcomes and progress of your
                  website.
                </p>
              </div>
            </div>
          ...
          <div className="row">
            <div className="col-lg-4">
              ...
              <p className="customText text-off-white">
                determination of business objects play a very important role in
                building an effective marketing strategy. Each objective is the
                key point that should be achieved by the strategy to assure
            ...
            <div className="col-lg-4">
              <ul className="fb-ads-list">
                ...
                <li className="customText text-off-white">Boosts sales</li>
                <li className="customText text-off-white">Highly measurable</li>
              </ul>
            </div>
            <div className="col-lg-4">
              <ul className="fb-ads-list">
        ...
        <div className="containerFull">
          ...
          <div className="row">
            <div className="col-lg-3">
              <div className="fb-ads-management-box">
                <img
                  src="assets/images/icons/facebook-ads-managemnet-image-ads.svg"
                  alt="Facebook ads managemnet ads"
                />
                <h4>Image Ads</h4>
                <p className="customText">
                  These ads contain images that are responsible for spreading
                  brand awareness. These are designed in a way that the users
                  remember your brand even if they saw it once. These ads are
                  found everywhere and are a great source to boost brand
            ...
            <div className="col-lg-3">
              <div className="fb-ads-management-box">
                <img
                  src="assets/images/icons/facebook-ads-managemnet-local-awareness-ads.svg"
                  alt="facebook-ads-managemnet-local-awareness-ads"
                />
                <h4>Local awareness ads</h4>
                <p className="customText">
                  These ads help businesses to reach customers in their local
                  geographical area. This ad targets the audience according to
                  their physical proximity to your store.
                </p>
              </div>
            </div>
            <div className="col-lg-3">
              <div className="fb-ads-management-box">
                <img
                  src="assets/images/icons/facebook-ads-managemnet-video-ads.svg"
                  alt="facebook-ads-managemnet-video-ads"
                />
                <h4>Video ads</h4>
                <p className="customText">
                  These ads are the most powerful way to engage the audience.
                  People are attracted to videos and GIFs instantly; this leads
                  to a great platform to advertise your products with a short or
                  detailed video.
                </p>
              </div>
            </div>
            <div className="col-lg-3">
              <div className="fb-ads-management-box">
                <img
                  src="assets/images/icons/facebook-ads-managemnet-link-click-ads.svg"
                  alt="facebook-ads-managemnet-link-click-ads"
                />
                <h4>Link click ads</h4>
                <p className="customText">
                  These ads are the most commonly used by marketers. It allows
                  us to place images, write ad content and add the external link
                  of the landing page.
                </p>
              </div>
            </div>
          ...
          <div className="row">
            <div className="col-lg-3">
              <div className="fb-ads-management-box">
                <img
                  src="assets/images/icons/facebook-ads-managemnet-carousel-ads.svg"
                  alt="facebook-ads-managemnet-carousel-ads"
                />
                <h4>Carousel ads</h4>
                <p className="customText">
                  These ads are beneficial to promote multiple products at once.
                  You can showcase 10 products where each product leads to its
                  page on the store.
                </p>
              </div>
            </div>
            <div className="col-lg-3">
              <div className="fb-ads-management-box">
                <img
                  src="assets/images/icons/facebooc-ads-management-website-traffic.svg"
                  alt="facebooc-ads-management-website-traffic"
                />
                <h4>Increase in website traffic</h4>
                <p className="customText">
                  Responsive web pages work smoothly on all devices like
                  desktops, mobiles, smartphones and tablets. This makes the
                  website accessible to the majority of Internet users and leads
                  to greater traffic rates.
                </p>
              </div>
            </div>
            <div className="col-lg-3">
              <div className="fb-ads-management-box">
                <img
                  src="assets/images/icons/facebook-ads-management-offer-ads.svg"
                  alt="facebook-ads-management-offer-ads"
                />
                <h4>Offer ads</h4>
                <p className="customText">
                  These ads display the current appealing and attractive offers
                  to the audience. These ads attract huge mass by displaying
                  store coupon offers, discounts, free trials or gifts.
                </p>
              </div>
            </div>
            <div className="col-lg-3">
          ...
          <div className="row">
            <div className="col-lg-3">
              <div className="fb-ads-management-box">
                <img
                  src="assets/images/icons/facebook-ads-managemnt-dynamic-product-ads.svg"
                  alt="facebook-ads-managemnt-dynamic-product-ads"
                />
                <h4>Dynamic product ads</h4>
                <p className="customText">
                  It is an advanced type of ad that targets the audience
                  according to their previous actions. These ads are useful for
                  remarketing; it delivers the right message at the right time
                  to the right people if they have ever interacted with your
                  website.
                </p>
              </div>
            </div>
            <div className="col-lg-3">
              <div className="fb-ads-management-box">
                <img
                  src="assets/images/icons/facebook-ads-management-canvas-ads.svg"
                  alt="facebook-ads-management-canvas-ads"
                />
                <h4>Canvas ads</h4>
                <p className="customText">
                  These ads are used to build landing pages with the brand logo,
                  text and images of your products and services. These ads are
                  highly flexible and versatile that enable you to implement
                  vivid creative expressions.
                </p>
              </div>
            </div>
            <div className="col-lg-3">
              <div className="fb-ads-management-box">
                <img
                  src="assets/images/icons/facebook-ads-management-collection-ads.svg"
                  alt="facebook-ads-management-collection-ads"
                />
                <h4>Collection ads</h4>
                <p className="customText">
                  These ads feature a set of products that your brand offers on
                  the website. These ads are useful for eCommerce stores with a
                  diverse range of products, these ads engage the audience with
                  a similar type of products they looked earlier.
                </p>
              </div>
            </div>
            <div className="col-lg-3">
              <div className="fb-ads-management-box">
                <img
                  src="assets/images/icons/facebook-ads-management-slidshow-ads.svg"
                  alt="facebook-ads-management-slidshow-ads"
                />
                <h4>Slideshow ads</h4>
                <p className="customText">
                  Facebook slide show ads are the type of facebook advertisement
                  where video-like ads use a series of still images and effects
                  that show motion, play sound, and display text to showcase
                  your story. This is the best type of ad format to showcase
      ...
      {/* <section className="blueBg2">
        <div className="containerFull">
          <div className="callAction">
            ...
            <p className="customText text-off-white">
              with the best Facebook advertising company in India with offices
              in Mumbai and Delhi?
            </p>
